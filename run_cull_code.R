...
output_name_1 <- "./lit_search_results/flag_tbls/all_result_tbl_flagged_1.csv"

table_of_flags <- read.csv("flag_descriptions.csv")


user_flag_input(all_dedup_path,output_name_1,table_of_flags)
